...
#echo $USER@$HOST  $(uname -srm) $(lsb_release -srcd)
...
# starship propt (https://starship.rs/)
eval "$(starship init zsh)"

# system info with pfetch (https://github.com/dylanaraps/pfetch)
PF_INFO="ascii title os host kernel shell wm uptime" pfetch
